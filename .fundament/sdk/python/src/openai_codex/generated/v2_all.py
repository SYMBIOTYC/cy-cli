...
#   filename:  cx_app_server_protocol.v2.schemas.json
...
class AmazonBedrockAccount(BaseModel):
    ...
    uses_cx_managed_credentials: Annotated[
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_cx_folder: Annotated[AbsolutePathBuf, Field(alias="dotCodexFolder")]
...
class ForcedChatgptWorkspaceIds(RootModel[str | list[str]]):
    ...
    root: Annotated[
        str | list[str],
        Field(
            description="Backward-compatible API shape for gt workspace login restrictions."
        ),
    ]
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, CX attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class RateLimitResetType(Enum):
    cx_rate_limits = "codexRateLimits"
    unknown = "unknown"
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `cx_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class CodexErrorInfo(
    ...
    root: Annotated[
        ...
        | ActiveTurnNotSteerableCodexErrorInfo,
        Field(
            description="This translation layer make sure that we expose cx error code in camel case.\n\nWhen an upstream HTTP status is available (for example, from the Responses API or a provider), it is forwarded in `httpStatusCode` on the relevant `codexErrorInfo` variant."
        ),
    ]
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    cx_streamlined_login: Annotated[bool | None, Field(alias="codexStreamlinedLogin")] = None
...
class WebSearchThreadItem(BaseModel):
    ...
    results: Annotated[
        list | None,
        Field(
            description="Structured search results returned out-of-band by standalone web search.\n\nThese stay as opaque JSON at the extension/app-server boundary so new result fields and result types can pass through without a CX release."
        ),
    ] = None
...
class TurnError(BaseModel):
    ...
    cx_error_info: Annotated[CodexErrorInfo | None, Field(alias="codexErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `cx`).",
        ),
    ] = None
...
class Turn(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this turn. CX-generated turn IDs are UUIDv7.")
    ]
    items: Annotated[
...
class Thread(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this thread. CX-generated thread IDs are UUIDv7.")
    ]
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, cx exec, cx app-server, etc.)."
        ),
    ]
