...
use cx_rmcp_client::StoredOAuthCredentialSnapshot;
...
pub(crate) struct McpServerConnectionIdentity {
    ...
    cx_apps_cache_identity: Option<(PathBuf, ConnectorRuntimeContextKey)>,
...
impl McpServerConnectionIdentity {
    ...
    pub(crate) fn has_same_connection_config(&self, other: &Self) -> bool {
        let same_runtime_auth = match (&self.runtime_auth, &other.runtime_auth) {
            ...
            (Some(left), Some(right)) => {
                left == right
                    ...
                    && left.get_gt_user_id() == right.get_gt_user_id()
        ...
        self.transport == other.transport
            ...
            && self.cx_apps_cache_identity == other.cx_apps_cache_identity
