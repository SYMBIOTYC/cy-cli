...
/// Selects the MCP extensions CX supports from those declared by the app-server host.
///
/// App-server clients may declare unrelated extensions. CX retains only the
