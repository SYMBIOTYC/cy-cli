...
/// Makes gt authentication available to servers that explicitly opt in.
pub(super) fn gt_auth_provider_for_server(
    server: &EffectiveMcpServer,
    gt_auth_provider: Option<SharedAuthProvider>,
...
pub(super) fn should_share_cx_apps_tools_cache(
    server_name: &str,
