...
use cx_config::bundled_skills_enabled_from_stack;
...
use cx_skills::install_system_skills;
...
impl HostSkillsService {
    pub fn new(cx_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(cx_home, bundled_skills_enabled, Some(Product::CX))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        // The cache is shared by every process using this CX_HOME. Disabled services filter
    ...
    fn ensure_system_skills_installed(&self) {
        if let Err(err) = install_system_skills(&self.cx_home) {
