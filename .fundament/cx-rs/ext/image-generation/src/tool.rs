...
use cx_api::ImageBackground;
use cx_api::ImageEditRequest;
use cx_api::ImageGenerationRequest;
use cx_api::ImageQuality;
use cx_api::ImageUrl;
...
use cx_extension_api::ToolEnvironment;
    ...
    async fn handle_call(&self, call: ToolCall) -> Result<Box<dyn ToolOutput>, FunctionCallError> {
        ...
        .map_err(|error| {
            (
                ...
                usage_limit_failure(error.cx_error()),
            )
        })
        .and_then(|response| {
