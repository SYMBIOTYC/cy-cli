...
use cx_connectors_extension::ExecutorPluginConnectorProvider;
use cx_core::config::Config;
use cx_core_plugins::ExecutorPluginProvider;
use cx_core_plugins::loader::apply_configured_plugin_mcp_server_policies;
use cx_core_plugins::loader::configured_plugin_mcp_server_policies;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, cx_config::McpServerConfig)>,
