...
use cx_extension_api::ThreadOriginator;
...
const TOOL_CALL_LAG_METRIC: &str = "cx.guardian_v2.tool_call_lag";
const REVIEW_FALLBACK_METRIC: &str = "cx.guardian_v2.review_fallback";
const CLASSIFICATION_METRIC: &str = "cx.guardian_v2.classification";
const CLASSIFICATION_DURATION_METRIC: &str = "cx.guardian_v2.classification.duration_ms";
    ...
    async fn score_tool(&self, input: ToolStartInput<'_>) {
        ...
        tokio::spawn(async move {
            ...
            classification_input.extend([
                ">>> TRANSCRIPT END\n\n".to_owned(),
                "The CX agent has requested the following action:\n".to_owned(),
