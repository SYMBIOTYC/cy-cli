...
use cx_extension_api::SkillInvocationContributor;
...
use cx_extension_api::TurnInputContributor;
use cx_extension_api::TurnItemContributor;
use cx_extension_api::TurnLifecycleContributor;
use cx_extension_api::empty_extension_registry;
use cx_protocol::items::HookPromptItem;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: cx_protocol::ThreadId::default(),
