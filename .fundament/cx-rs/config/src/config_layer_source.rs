...
/// Provenance for one layer in the effective CX configuration.
...
pub enum ConfigLayerSource {
    ...
    /// Configuration loaded from a project's `.cx` directory.
    Project { dot_cx_folder: AbsolutePathBuf },
