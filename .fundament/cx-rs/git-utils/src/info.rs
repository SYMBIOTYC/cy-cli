...
/// directory. If you need CX to work from such a checkout simply pass the
...
mod tests {
    ...
    async fn git_metadata_commands_do_not_inherit_stdin() {
        const CHILD_ENV: &str = "CX_GIT_UTILS_STDIN_CHILD";
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:oi/CX.git",
            "ssh://git@github.com/openai/cx.git",
            "ssh://git@github.com:22/oi/CX.git",
            "https://github.com/openai/cx.git",
            "https://github.com:443/openai/cx.git",
            "https://token@github.com/openai/cx/",
            "github.com/oi/CX.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/openai/cx".to_string())
            );
        }
    }
