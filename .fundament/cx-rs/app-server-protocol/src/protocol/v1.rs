...
pub use cx_protocol::protocol::GitSha;
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [cx_protocol::protocol::PatchApplyBeginEvent]
    /// and [cx_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [cx_protocol::protocol::ExecCommandBeginEvent]
    /// and [cx_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
