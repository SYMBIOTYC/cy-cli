...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a CX sandbox.
...
server_request_definitions! {
    ...
    ChatgptAuthTokensRefresh => "account/gtAuthTokens/refresh" {
...
/// Superset of [`cx_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by CX Cloud.
...
mod tests {
    ...
    fn jsonrpc_request_conversion_preserves_serde_enum_decoding() {
        let requests = [
            JSONRPCRequest {
                ...
                trace: Some(cx_protocol::protocol::W3cTraceContext {
    ...
    #[test]
    fn serialize_gt_auth_tokens_refresh_request() -> Result<()> {
        ...
        assert_eq!(
            json!({
                "method": "account/gtAuthTokens/refresh",
                "id": 8,
                "params": {
                    "reason": "unauthorized",
    ...
    #[test]
    fn serialize_account_login_gt_streamlined() -> Result<()> {
        let request = ClientRequest::LoginAccount {
            request_id: RequestId::Integer(3),
            params: v2::LoginAccountParams::Chatgpt {
                app_brand: None,
    ...
    #[test]
    fn serialize_account_login_gt_with_hosted_success_page() -> Result<()> {
        let request = ClientRequest::LoginAccount {
            request_id: RequestId::Integer(3),
            params: v2::LoginAccountParams::Chatgpt {
    ...
    #[test]
    fn serialize_account_login_gt_device_code() -> Result<()> {
        let request = ClientRequest::LoginAccount {
    ...
    #[test]
    fn serialize_account_login_gt_auth_tokens() -> Result<()> {
        let request = ClientRequest::LoginAccount {
            request_id: RequestId::Integer(6),
            params: v2::LoginAccountParams::ChatgptAuthTokens {
                access_token: "access-token".to_string(),
                gt_account_id: "org-123".to_string(),
                gt_plan_type: Some("business".to_string()),
            },
        };
        assert_eq!(
            json!({
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let gt_without_email = v2::Account::Chatgpt {
            email: None,
    ...
    fn serialize_thread_realtime_start() -> Result<()> {
        let request = ClientRequest::ThreadRealtimeStart {
            ...
            params: v2::ThreadRealtimeStartParams {
                ...
                cx_response_handoff_channel_prefixes: Some(std::collections::BTreeMap::from([
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: cx_protocol::config_types::CollaborationMode {
                        mode: cx_protocol::config_types::ModeKind::Default,
