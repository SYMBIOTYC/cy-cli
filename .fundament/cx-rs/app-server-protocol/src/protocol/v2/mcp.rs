...
use cx_protocol::items::McpToolCallError as CoreMcpToolCallError;
use cx_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use cx_protocol::mcp::McpServerInfo;
use cx_protocol::mcp::Resource as McpResource;
pub use cx_protocol::mcp::ResourceContent as McpResourceContent;
use cx_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use cx_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from cx_protocol::protocol::McpAuthStatus {
        Unknown,
        Unsupported,
        NotLoggedIn,
        BearerToken,
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from cx_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> cx_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => cx_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => cx_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => cx_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active CX turn when this elicitation was observed, if app-server could correlate one.
    ///
