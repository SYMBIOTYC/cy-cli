...
use crate::TS;
use cx_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use cx_protocol::protocol::SkillInterface as CoreSkillInterface;
use cx_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use cx_protocol::protocol::SkillScope as CoreSkillScope;
use cx_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// CX app-server exposes `"AVAILABLE"` in its API; the alias keeps
