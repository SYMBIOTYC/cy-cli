...
use cx_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use cx_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use cx_protocol::user_input::ByteRange as CoreByteRange;
use cx_protocol::user_input::TextElement as CoreTextElement;
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich CX's ResponsesAPI turn metadata.
    ///
    /// Entries are flattened into the JSON string sent as
    /// `client_metadata["x-cx-turn-metadata"]` on ResponsesAPI HTTP and websocket requests.
    ///
