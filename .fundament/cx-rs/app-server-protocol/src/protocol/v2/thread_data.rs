...
use cx_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use cx_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. CX-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, cx exec, cx app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. CX-generated turn IDs are UUIDv7.
    pub id: String,
