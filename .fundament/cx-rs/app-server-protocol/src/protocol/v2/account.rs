...
use cx_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use cx_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use cx_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use cx_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use cx_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
...
pub enum Account {
    ...
    #[serde(rename = "gt", rename_all = "camelCase")]
    #[ts(rename = "gt", rename_all = "camelCase")]
    Chatgpt {
        #[schemars(
            required,
...
pub enum LoginAccountParams {
    ...
    #[serde(rename = "gtDeviceCode")]
    #[ts(rename = "gtDeviceCode")]
    ChatgptDeviceCode,
    /// [UNSTABLE] FOR OPENAI INTERNAL USE ONLY - DO NOT USE.
    /// The access token must contain the same scopes that CX-managed gt auth tokens have.
    #[experimental("account/login/start.gtAuthTokens")]
...
pub enum LoginAccountResponse {
    ...
    #[serde(rename = "gtDeviceCode", rename_all = "camelCase")]
    #[ts(rename = "gtDeviceCode", rename_all = "camelCase")]
    ChatgptDeviceCode {
        // Use plain String for identifiers to avoid TS/JSON Schema quirks around uuid-specific types.
        // Convert to/from UUIDs at the application layer as needed.
        login_id: String,
...
pub enum ChatgptAuthTokensRefreshReason {
    /// CX attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshResponse {
    ...
    pub gt_account_id: String,
    pub gt_plan_type: Option<String>,
}
...
impl fmt::Debug for ChatgptAuthTokensRefreshResponse {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("ChatgptAuthTokensRefreshResponse")
            ...
            .field("gt_plan_type", &self.gt_plan_type)
            .finish()
    }
}
...
pub struct GetAccountRateLimitsResponse {
    ...
    /// Multi-bucket view keyed by metered `limit_id` (for example, `cx`).
