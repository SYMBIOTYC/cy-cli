...
use cx_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use cx_protocol::protocol::TokenUsage as CoreTokenUsage;
use cx_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "cx_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. CX Cloud).
...
impl From<cx_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: cx_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> cx_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => cx_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => cx_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `cx_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
