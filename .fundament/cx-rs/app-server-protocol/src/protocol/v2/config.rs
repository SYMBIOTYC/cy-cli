...
pub enum ConfigLayerSource {
    /// Default configuration supplied with the installed CX package.
    ...
    /// User config layer from $CX_HOME/config.toml. This layer is special
    ...
    /// Path to a .cx/ folder within a project. There could be multiple of
...
/// Backward-compatible API shape for gt workspace login restrictions.
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, JsonSchema, TS)]
#[serde(untagged)]
#[ts(export_to = "v2/")]
