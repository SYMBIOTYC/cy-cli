...
use crate::TS;
use cx_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use cx_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use cx_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use cx_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use cx_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use cx_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use cx_protocol::models::LegacyReadWriteRoots;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> cx_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<cx_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: cx_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            cx_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            cx_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            cx_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
