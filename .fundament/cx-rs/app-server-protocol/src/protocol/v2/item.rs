...
use cx_experimental_api_macros::ExperimentalApi;
use cx_extension_items::ExtensionItem;
pub use cx_extension_items::image_generation::ImageGenerationFailure;
pub use cx_extension_items::image_generation::ImageGenerationItem;
pub use cx_extension_items::sleep::SleepItem;
pub use cx_extension_items::web_search::WebSearchAction;
pub use cx_extension_items::web_search::WebSearchItem;
use cx_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use cx_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use cx_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use cx_protocol::items::AgentMessageContent as CoreAgentMessageContent;
pub use cx_protocol::items::AgentMessageDelivery;
...
use cx_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use cx_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use cx_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use cx_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use cx_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: cx_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        ...
        cx_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<cx_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: cx_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<cx_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: cx_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for cx_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
