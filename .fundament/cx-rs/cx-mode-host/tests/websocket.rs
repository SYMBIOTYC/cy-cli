...
use anyhow::Context;
use anyhow::Result;
use cx_code_mode::CellId;
use cx_code_mode::CodeModeSessionCellExecutionLimits;
use cx_code_mode::CodeModeSessionProvider;
use cx_code_mode::CodeModeToolKind;
use cx_code_mode::ExecuteRequest;
use cx_code_mode::FunctionCallOutputContentItem;
use cx_code_mode::NoopCodeModeSessionDelegate;
use cx_code_mode::RuntimeResponse;
use cx_code_mode::ToolDefinition;
use cx_code_mode::WebSocketCodeModeSessionProvider;
use cx_code_mode_protocol::host::Capability;
use cx_code_mode_protocol::host::CapabilitySet;
use cx_code_mode_protocol::host::ClientHello;
use cx_code_mode_protocol::host::ClientToHost;
use cx_code_mode_protocol::host::DUAL_WEBSOCKET_CAPABILITY;
use cx_code_mode_protocol::host::DelegateRequest;
use cx_code_mode_protocol::host::DelegateResponse;
use cx_code_mode_protocol::host::EncodedFrame;
use cx_code_mode_protocol::host::HostHello;
use cx_code_mode_protocol::host::HostRequest;
use cx_code_mode_protocol::host::HostResponse;
use cx_code_mode_protocol::host::HostToClient;
use cx_code_mode_protocol::host::MAX_FRAME_BYTES;
use cx_code_mode_protocol::host::ProtocolVersion;
use cx_code_mode_protocol::host::RequestId;
use cx_code_mode_protocol::host::SESSION_RESOURCE_LIMITS_CAPABILITY;
use cx_code_mode_protocol::host::SessionId;
use cx_code_mode_protocol::host::SupportedProtocolVersions;
use cx_code_mode_protocol::host::WireContentItem;
use cx_code_mode_protocol::host::WireExecuteRequest;
use cx_code_mode_protocol::host::WireResult;
use cx_code_mode_protocol::host::WireRuntimeResponse;
use cx_code_mode_protocol::host::WireToolDefinition;
use cx_code_mode_protocol::host::WireToolKind;
use cx_code_mode_protocol::host::WireToolName;
use cx_code_mode_protocol::host::WireWaitRequest;
...
async fn websocket_control_operations_bypass_an_incomplete_bulk_frame() -> Result<()> {
    ...
    let bulk_message = ClientToHost::DelegateResponse {
        id: cx_code_mode_protocol::host::DelegateRequestId::new(/*value*/ 999),
        result: WireResult::Ok {
            value: DelegateResponse::ToolResult {
        ...
        .send(&ClientToHost::Request {
            ...
            request: HostRequest::Wait {
                ...
                request: WireWaitRequest {
                    cell_id: cx_code_mode_protocol::host::WireCellId::new("missing-cell"),
                    yield_time_ms: 10,
                },
            },
        })
