...
///
/// The active gt account id represents the selected personal account or workspace, while the
/// gt user id identifies the account principal. Keeping both plus workspace classification
