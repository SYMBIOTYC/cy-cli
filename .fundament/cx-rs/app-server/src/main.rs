use clap::Parser;
use cx_app_server::AppServerCodeModeHostArgs;
use cx_app_server::AppServerRuntimeOptions;
use cx_app_server::AppServerTransport;
use cx_app_server::AppServerWebsocketAuthArgs;
...
const MANAGED_CONFIG_PATH_ENV_VAR: &str = "CX_APP_SERVER_MANAGED_CONFIG_PATH";
    ...
    arg0_dispatch_or_else(move |arg0_paths: Arg0DispatchPaths| async move {
        ...
        runtime_options.remote_control_startup_mode =
            match (remote_control, remote_control_disabled) {
                ...
                (false, true) => cx_app_server::RemoteControlStartupMode::DisabledEphemeral,
                (false, false) => cx_app_server::RemoteControlStartupMode::ResolvePersisted,
            };
