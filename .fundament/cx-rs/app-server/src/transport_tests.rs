    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: cx_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        cx_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                cx_app_server_protocol::AdditionalFileSystemPermissions {
