...
use cx_app_server_protocol::Project;
use cx_app_server_protocol::ProjectChangeType;
use cx_app_server_protocol::ProjectChangedNotification;
use cx_app_server_protocol::ProjectCreateParams;
use cx_app_server_protocol::ProjectCreateResponse;
use cx_app_server_protocol::ProjectDeleteParams;
use cx_app_server_protocol::ProjectDeleteResponse;
use cx_app_server_protocol::ProjectImportParams;
use cx_app_server_protocol::ProjectImportResponse;
use cx_app_server_protocol::ProjectListParams;
use cx_app_server_protocol::ProjectListResponse;
use cx_app_server_protocol::ProjectMoveParams;
use cx_app_server_protocol::ProjectMoveResponse;
use cx_app_server_protocol::ProjectReadParams;
use cx_app_server_protocol::ProjectReadResponse;
use cx_app_server_protocol::ProjectRoot;
use cx_app_server_protocol::ProjectUpdateParams;
use cx_app_server_protocol::ProjectUpdateResponse;
use cx_app_server_protocol::ServerNotification;
use cx_app_server_protocol::ThreadProjectUpdatedNotification;
use cx_thread_store::CreateProjectParams as StoreCreateProjectParams;
use cx_thread_store::ListProjectsParams as StoreListProjectsParams;
use cx_thread_store::MoveProjectParams as StoreMoveProjectParams;
use cx_thread_store::ProjectMoveOutcome;
use cx_thread_store::StoredProject;
use cx_thread_store::StoredProjectRoot;
use cx_thread_store::ThreadStore;
use cx_thread_store::ThreadStoreError;
use cx_thread_store::UpdateProjectParams as StoreUpdateProjectParams;
...
fn validate_roots(roots: Vec<ProjectRoot>) -> Result<Vec<StoredProjectRoot>, JSONRPCErrorError> {
    ...
    roots
        .into_iter()
        .map(|root| {
            let path = cx_utils_absolute_path::AbsolutePathBuf::from_absolute_path_checked(
...
fn api_project(project: StoredProject) -> Result<Project, JSONRPCErrorError> {
    Ok(Project {
        ...
        roots: project
            ...
            .map(|root| {
                Ok(ProjectRoot {
                    path: cx_utils_absolute_path::AbsolutePathBuf::from_absolute_path(root.path)
                        .map_err(|error| {
