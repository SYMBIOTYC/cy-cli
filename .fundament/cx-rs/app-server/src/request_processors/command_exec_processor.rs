use super::*;
use cx_core::exec_env::inject_apply_patch_env;
    ...
    async fn exec_one_off_command_inner(
        ...
        let (
            ...
            let file_system_sandbox_policy =
                cx_protocol::permissions::FileSystemSandboxPolicy::from_legacy_sandbox_policy_for_cwd(&policy, &sandbox_cwd);
            let network_sandbox_policy =
                cx_protocol::permissions::NetworkSandboxPolicy::from(&policy);
            let permission_profile =
                cx_protocol::models::PermissionProfile::from_runtime_permissions_with_enforcement(
                    cx_protocol::models::SandboxEnforcement::from_legacy_sandbox_policy(&policy),
        ...
        let cx_linux_sandbox_exe = self.arg0_paths.cx_linux_sandbox_exe.clone();
        ...
        let exec_request = cx_core::exec::build_exec_request(
            exec_params,
            &effective_permission_profile,
            &sandbox_cwd,
