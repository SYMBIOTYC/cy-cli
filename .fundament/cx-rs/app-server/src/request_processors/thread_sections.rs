...
use cx_app_server_protocol::ThreadSectionCreateResponse;
use cx_app_server_protocol::ThreadSectionDeleteParams;
use cx_app_server_protocol::ThreadSectionDeleteResponse;
use cx_app_server_protocol::ThreadSectionListParams;
use cx_app_server_protocol::ThreadSectionListResponse;
use cx_app_server_protocol::ThreadSectionUpdateParams;
use cx_app_server_protocol::ThreadSectionUpdateResponse;
use cx_state::PINNED_THREAD_SECTION_ID;
use cx_thread_store::CreateThreadSectionParams as StoreCreateThreadSectionParams;
use cx_thread_store::DeleteThreadSectionParams as StoreDeleteThreadSectionParams;
use cx_thread_store::ListThreadSectionsParams as StoreListThreadSectionsParams;
use cx_thread_store::RenameThreadSectionParams as StoreRenameThreadSectionParams;
use cx_thread_store::StoredThreadSection;
...
fn state_thread_section_appearance(
    appearance: ThreadSectionAppearance,
) -> cx_state::ThreadSectionAppearance {
    cx_state::ThreadSectionAppearance {
        icon: appearance.icon,
        color: appearance.color,
    }
