...
use cx_app_server_protocol::CommandMigration;
...
use cx_app_server_protocol::ExternalAgentConfigImportHistory;
...
use cx_app_server_protocol::ExternalAgentDetectedConnectorCandidate;
use cx_app_server_protocol::ExternalAgentDetectedConnectorSource;
use cx_app_server_protocol::HookMigration;
use cx_app_server_protocol::JSONRPCErrorError;
use cx_app_server_protocol::McpServerMigration;
use cx_app_server_protocol::MigrationDetails;
use cx_app_server_protocol::PluginsMigration;
use cx_app_server_protocol::SkillMigration;
use cx_app_server_protocol::SubagentMigration;
use cx_external_agent_migration::DetectedConnectorCandidate as CoreDetectedConnectorCandidate;
use cx_external_agent_migration::DetectedConnectorSource as CoreDetectedConnectorSource;
use cx_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use cx_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use cx_external_agent_migration::ExternalAgentConfigImportSuccess;
use cx_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use cx_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use cx_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use cx_external_agent_migration::NamedMigration;
use cx_external_agent_migration::PluginsMigration as CorePluginsMigration;
use cx_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| cx_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: cx_state::ExternalAgentConfigImportHistoryRecord,
