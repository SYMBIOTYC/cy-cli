...
use cx_analytics::ExternalAgentConfigImportCompletedInput;
use cx_analytics::ExternalAgentConfigImportFailureInput;
...
use cx_app_server_protocol::ExternalAgentConfigImportHistoryRecordParams;
use cx_app_server_protocol::ExternalAgentConfigImportHistoryRecordResponse;
use cx_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use cx_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
...
use cx_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
...
use cx_external_agent_migration::DetectedConnectorCandidate;
use cx_external_agent_migration::ExternalAgentConfigDetectOptions;
use cx_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use cx_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use cx_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use cx_external_agent_migration::ExternalAgentConfigService;
use cx_external_agent_migration::ExternalAgentSessionImportLimits;
use cx_external_agent_migration::PluginImportOutcome;
use cx_external_agent_migration::record_import_error;
use cx_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use cx_external_agent_migration::sessions::read_imported_connector_candidates;
use cx_external_agent_migration::sessions::record_detected_session_connectors;
use cx_features::Feature;
use cx_rollout::StateDbHandle;
use cx_state::ExternalAgentConfigImportFailureRecord;
use cx_state::ExternalAgentConfigImportSuccessRecord;
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn detect(
        ...
        record_detected_session_connectors(
            self.migration_service.cx_home(),
    ...
    pub(crate) async fn read_import_histories(
        ...
        let connectors = read_imported_connector_candidates(self.migration_service.cx_home())
            .map_err(|err| {
                internal_error(format!(
