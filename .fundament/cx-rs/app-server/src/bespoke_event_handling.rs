...
use cx_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use cx_app_server_protocol::CodexErrorInfo as V2CodexErrorInfo;
use cx_app_server_protocol::CommandAction as V2ParsedCommand;
use cx_app_server_protocol::CommandExecutionApprovalDecision;
use cx_app_server_protocol::CommandExecutionPresentation;
use cx_app_server_protocol::CommandExecutionRequestApprovalParams;
use cx_app_server_protocol::CommandExecutionRequestApprovalResponse;
use cx_app_server_protocol::CommandExecutionSource;
use cx_app_server_protocol::CommandExecutionStatus;
use cx_app_server_protocol::DeprecationNoticeNotification;
use cx_app_server_protocol::DynamicToolCallParams;
use cx_app_server_protocol::EnvironmentConnectionNotification;
use cx_app_server_protocol::ErrorNotification;
use cx_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use cx_app_server_protocol::FileChangeApprovalDecision;
use cx_app_server_protocol::FileChangeRequestApprovalParams;
use cx_app_server_protocol::FileChangeRequestApprovalResponse;
use cx_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use cx_app_server_protocol::GuardianWarningNotification;
use cx_app_server_protocol::HookCompletedNotification;
use cx_app_server_protocol::HookStartedNotification;
use cx_app_server_protocol::ItemCompletedNotification;
use cx_app_server_protocol::ItemStartedNotification;
use cx_app_server_protocol::McpServerElicitationAction;
use cx_app_server_protocol::McpServerElicitationRequestParams;
use cx_app_server_protocol::McpServerElicitationRequestResponse;
use cx_app_server_protocol::McpServerStartupState;
use cx_app_server_protocol::McpServerStatusUpdatedNotification;
use cx_app_server_protocol::ModelReroutedNotification;
use cx_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use cx_app_server_protocol::ModelVerificationNotification;
use cx_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use cx_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use cx_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use cx_app_server_protocol::PermissionsRequestApprovalParams;
use cx_app_server_protocol::PermissionsRequestApprovalResponse;
use cx_app_server_protocol::RawResponseCompletedNotification;
use cx_app_server_protocol::RawResponseItemCompletedNotification;
use cx_app_server_protocol::RequestId;
use cx_app_server_protocol::ServerNotification;
use cx_app_server_protocol::ServerRequestPayload;
use cx_app_server_protocol::StrictReviewRequiredNotification;
use cx_app_server_protocol::ThreadGoalUpdatedNotification;
use cx_app_server_protocol::ThreadItem;
use cx_app_server_protocol::ThreadRealtimeClosedNotification;
use cx_app_server_protocol::ThreadRealtimeErrorNotification;
use cx_app_server_protocol::ThreadRealtimeItemAddedNotification;
use cx_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use cx_app_server_protocol::ThreadRealtimeSdpNotification;
use cx_app_server_protocol::ThreadRealtimeStartedNotification;
use cx_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use cx_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use cx_app_server_protocol::ThreadRollbackResponse;
use cx_app_server_protocol::ThreadSettingsUpdatedNotification;
use cx_app_server_protocol::ThreadStatus;
use cx_app_server_protocol::ThreadTokenUsage;
use cx_app_server_protocol::ThreadTokenUsageUpdatedNotification;
...
use cx_app_server_protocol::ToolRequestUserInputResponse;
use cx_app_server_protocol::Turn;
use cx_app_server_protocol::TurnCompletedNotification;
use cx_app_server_protocol::TurnDiffUpdatedNotification;
...
use cx_app_server_protocol::TurnModerationMetadataNotification;
use cx_app_server_protocol::TurnPlanStep;
use cx_app_server_protocol::TurnPlanUpdatedNotification;
use cx_app_server_protocol::TurnStartedNotification;
use cx_app_server_protocol::TurnStatus;
use cx_app_server_protocol::WarningNotification;
use cx_app_server_protocol::build_item_from_guardian_event;
use cx_app_server_protocol::guardian_auto_approval_review_notification;
use cx_app_server_protocol::item_event_to_server_notification;
use cx_core::CodexThread;
use cx_core::ThreadManager;
use cx_guardian_v2::StrictReviewReason;
use cx_protocol::ThreadId;
use cx_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use cx_protocol::items::TurnItem as CoreTurnItem;
use cx_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use cx_protocol::plan_tool::UpdatePlanArgs;
use cx_protocol::protocol::CodexErrorInfo as CoreCodexErrorInfo;
use cx_protocol::protocol::Event;
use cx_protocol::protocol::EventMsg;
use cx_protocol::protocol::ExecApprovalRequestEvent;
use cx_protocol::protocol::Op;
use cx_protocol::protocol::RealtimeEvent;
use cx_protocol::protocol::ReviewDecision;
use cx_protocol::protocol::SubAgentActivityKind;
...
use cx_protocol::protocol::TurnDiffEvent;
use cx_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use cx_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use cx_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use cx_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use cx_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use cx_sandboxing::policy_transforms::intersect_permission_profiles;
use cx_shell_command::parse_command::shlex_join;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    match msg {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == cx_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                cx_protocol::protocol::GuardianAssessmentStatus::Denied
                | cx_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                cx_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                cx_protocol::protocol::GuardianAssessmentStatus::InProgress
                | cx_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: cx_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let cx_error_info = ev.cx_error_info.clone();
            ...
            let turn_error = TurnError {
                message: ev.message,
                cx_error_info: ev.cx_error_info.map(V2CodexErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: cx_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: cx_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: cx_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<CodexThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: cx_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            cx_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use cx_app_server_protocol::TurnPlanStepStatus;
    use cx_login::CodexAuth;
    use cx_protocol::AgentPath;
    use cx_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use cx_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use cx_protocol::items::DynamicToolCallItem;
    use cx_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use cx_protocol::items::SubAgentActivityItem;
    use cx_protocol::items::TurnItem as CoreTurnItem;
    use cx_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    ...
    use cx_protocol::plan_tool::PlanItemArg;
    use cx_protocol::plan_tool::StepStatus;
    use cx_protocol::protocol::AgentMessageEvent;
    use cx_protocol::protocol::AskForApproval;
    use cx_protocol::protocol::CreditsSnapshot;
    use cx_protocol::protocol::EventMsg;
    use cx_protocol::protocol::GuardianAssessmentEvent;
    use cx_protocol::protocol::GuardianAssessmentStatus;
    ...
    use cx_thread_store::StoredThreadHistory;
    use cx_utils_absolute_path::AbsolutePathBuf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: cx_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(cx_protocol::protocol::GuardianRiskLevel::Low),
                Some(cx_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(cx_protocol::protocol::GuardianRiskLevel::High),
                Some(cx_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(cx_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = cx_protocol::protocol::GuardianAssessmentAction::Command {
            source: cx_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: cx_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: cx_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(cx_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(cx_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    cx_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(cx_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(cx_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = cx_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: cx_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: cx_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            cx_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let thread_manager = Arc::new(
            cx_core::test_support::thread_manager_with_models_provider_and_home(
                CodexAuth::create_dummy_gt_auth_for_testing(),
                config.model_provider.clone(),
                config.cx_home.to_path_buf(),
                Arc::new(cx_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let cx_core::NewThread {
            thread_id: conversation_id,
            thread: conversation,
            ..
        } = thread_manager
            .start_thread(cx_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                cx_error_info: Some(V2CodexErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(cx_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(cx_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(cx_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
    ...
    async fn interrupted_subagent_activity_removes_missing_thread_watch() -> Result<()> {
        ...
        let cx_core::NewThread {
            ...
            .start_thread(cx_core::StartThreadOptions::new(config))
            .await?;
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: cx_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                cx_error_info: Some(V2CodexErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            ServerNotification::AccountRateLimitsUpdated(payload) => {
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("cx"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                cx_error_info: Some(V2CodexErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
