...
use cx_diagnostics::GaugeGuard;
use cx_otel::span_w3c_trace_context;
...
pub(crate) use cx_app_server_transport::OutgoingError;
pub(crate) use cx_app_server_transport::OutgoingMessage;
pub(crate) use cx_app_server_transport::OutgoingResponse;
...
mod tests {
    ...
    use cx_app_server_protocol::ApplyPatchApprovalParams;
    ...
    use cx_app_server_protocol::ModelRerouteReason;
    use cx_app_server_protocol::ModelReroutedNotification;
    use cx_app_server_protocol::ModelVerification;
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-cx".to_string(),
    ...
    async fn send_response_routes_to_target_connection() {
        ...
        let outgoing =
            OutgoingMessageSender::new(tx, cx_analytics::AnalyticsEventsClient::disabled());
        ...
        outgoing
            .send_response(
                ...
                ClientResponsePayload::ThreadArchive(
                    cx_app_server_protocol::ThreadArchiveResponse {},
                ),
            )
            .await;
