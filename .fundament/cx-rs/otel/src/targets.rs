pub(crate) const OTEL_TARGET_PREFIX: &str = "cx_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "cx_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "cx_otel.trace_safe";
