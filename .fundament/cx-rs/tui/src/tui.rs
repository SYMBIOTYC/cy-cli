...
/// Restore the terminal after CY is exiting.
///
...
impl Tui {
    pub(crate) fn new(
        ...
        let scrollback = ScrollbackStrategy::detect(&cx_terminal_detection::terminal_info());
    ...
    /// terminal modes and stderr while keeping raw mode enabled, then re-applies CX TUI modes
