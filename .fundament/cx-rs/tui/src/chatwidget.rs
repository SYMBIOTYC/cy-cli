...
use cx_app_server_protocol::CodexErrorInfo as AppServerCodexErrorInfo;
...
use cx_app_server_protocol::CommandExecutionSource as ExecCommandSource;
...
use cx_app_server_protocol::ModelVerification as AppServerModelVerification;
use cx_app_server_protocol::RateLimitReachedType;
...
use cx_app_server_protocol::SkillMetadata;
use cx_app_server_protocol::SkillsListResponse;
use cx_app_server_protocol::ThreadGoal as AppThreadGoal;
use cx_app_server_protocol::ThreadGoalStatus as AppThreadGoalStatus;
...
use cx_config::ConstraintResult;
...
#[cfg(test)]
use cx_git_utils::CommitLogEntry;
use cx_git_utils::current_branch_name;
use cx_git_utils::get_git_repo_root;
use cx_git_utils::local_git_branches;
use cx_git_utils::recent_commits;
use cx_otel::RuntimeMetricsSummary;
...
use cx_protocol::approvals::GuardianAssessmentAction;
use cx_protocol::approvals::GuardianAssessmentDecisionSource;
use cx_protocol::approvals::GuardianAssessmentEvent;
use cx_protocol::approvals::GuardianAssessmentStatus;
...
use cx_protocol::plan_tool::PlanItemArg as UpdatePlanItemArg;
use cx_protocol::plan_tool::StepStatus as UpdatePlanItemStatus;
...
use cx_utils_approval_presets::ApprovalPreset;
use cx_utils_approval_presets::builtin_approval_presets;
...
pub(crate) struct ChatWidgetInit {
    ...
    pub(crate) has_cx_backend_auth: bool,
    pub(crate) model_catalog: Arc<ModelCatalog>,
    pub(crate) feedback: cx_feedback::CodexFeedback,
...
/// and by sending requests back to cx-core.
///
...
pub(crate) struct ChatWidget {
    ...
    cx_rate_limit_reached_type: Option<RateLimitReachedType>,
    cx_spend_control_reached: Option<bool>,
    ...
    pub(crate) pet_http_client: cx_http_client::RouteAwareClientPool,
...
fn request_permissions_from_params(
    params: cx_app_server_protocol::PermissionsRequestApprovalParams,
...
impl ChatWidget {
    ...
    /// Forward a command directly to cx.
        ...
        T: Into<AppCommand>,
    {
        ...
        match &self.cx_op_target {
            CodexOpTarget::Direct(cx_op_tx) => {
                crate::session_log::log_outbound_op(&op);
                if let Err(e) = cx_op_tx.send(op) {
...
const PLACEHOLDER: &str = "Ask CX to do anything";
