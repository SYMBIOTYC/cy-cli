...
impl App {
    ...
    pub async fn run(
        ...
        let has_gt_account = bootstrap.has_gt_account;
        let has_cx_backend_auth = matches!(auth_mode, Some(TelemetryAuthMode::Chatgpt));
        ...
        let session_telemetry = SessionTelemetry::new(
            ...
            auth_mode,
            cx_login::default_client::originator().value,
        ...
        {
            session_telemetry.counter("cx.status_line", /*inc*/ 1, &[]);
        }
...
See the CX keymap documentation for supported actions and examples."
            )
        })?;
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            if should_check {
                ...
                let logs_base_dir = app.config.cx_home.clone();
        ...
        if requires_openai_auth && has_gt_account {
