...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for CX",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit CX",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Export => "export the conversation as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how CX performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for CX",
            ...
            SlashCommand::Permissions => "choose what CY is allowed to do",
            ...
            SlashCommand::Logout => "log out of CX",
