...
//! "leave the old title alone" or "clear the title CX last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title CX manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before CX started managing the title.
