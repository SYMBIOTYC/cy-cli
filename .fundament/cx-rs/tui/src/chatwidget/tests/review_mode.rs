...
async fn interrupted_turn_after_goal_budget_limited_uses_budget_message_snapshot() {
    ...
    chat.handle_server_notification(
        cx_app_server_protocol::ServerNotification::TurnStarted(
            cx_app_server_protocol::TurnStartedNotification {
                thread_id: "thread-1".to_string(),
                turn: cx_app_server_protocol::Turn {
                    id: "turn-1".to_string(),
                    items_view: cx_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: cx_app_server_protocol::TurnStatus::InProgress,
                    error: None,
                    started_at: None,
                    completed_at: None,
                    duration_ms: None,
    ...
    chat.handle_server_notification(
        cx_app_server_protocol::ServerNotification::ThreadGoalUpdated(
            cx_app_server_protocol::ThreadGoalUpdatedNotification {
                ...
                goal: cx_app_server_protocol::ThreadGoal {
                    ...
                    status: cx_app_server_protocol::ThreadGoalStatus::BudgetLimited,
    ...
    chat.handle_server_notification(
        cx_app_server_protocol::ServerNotification::TurnCompleted(
            cx_app_server_protocol::TurnCompletedNotification {
                thread_id: "thread-1".to_string(),
                turn: cx_app_server_protocol::Turn {
                    id: "turn-1".to_string(),
                    items_view: cx_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: cx_app_server_protocol::TurnStatus::Interrupted,
                    error: None,
                    started_at: None,
                    completed_at: None,
                    duration_ms: None,
