...
impl ChatWidget {
    ...
    pub(super) fn on_hook_started(&mut self, run: cx_app_server_protocol::HookRunSummary) {
    ...
    pub(super) fn on_hook_completed(&mut self, completed: cx_app_server_protocol::HookRunSummary) {
