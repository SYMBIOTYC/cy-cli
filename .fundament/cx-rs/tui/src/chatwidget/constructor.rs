...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(common: ChatWidgetInit, cx_op_target: CodexOpTarget) -> Self {
        let ChatWidgetInit {
            config,
            frame_requester,
            app_event_tx,
        ...
        let pet_http_client = cx_http_client::RouteAwareClientPool::new(
            config.http_client_factory(),
            cx_http_client::ClientRouteClass::Other,
        );
        ...
        let mut widget = Self {
            ...
            cx_rate_limit_reached_type: None,
            cx_spend_control_reached: None,
        ...
        widget
            .bottom_pane
            .set_token_activity_command_enabled(widget.has_cx_backend_auth);
