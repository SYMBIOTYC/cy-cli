...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: cx_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, cx_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                cx_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                cx_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                cx_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                cx_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                cx_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                cx_app_server_protocol::GuardianRiskLevel::Low => {
                    cx_protocol::approvals::GuardianRiskLevel::Low
                }
                cx_app_server_protocol::GuardianRiskLevel::Medium => {
                    cx_protocol::approvals::GuardianRiskLevel::Medium
                }
                cx_app_server_protocol::GuardianRiskLevel::High => {
                    cx_protocol::approvals::GuardianRiskLevel::High
                }
                cx_app_server_protocol::GuardianRiskLevel::Critical => {
                    cx_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    cx_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        cx_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    cx_app_server_protocol::GuardianUserAuthorization::Low => {
                        cx_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    cx_app_server_protocol::GuardianUserAuthorization::Medium => {
                        cx_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    cx_app_server_protocol::GuardianUserAuthorization::High => {
                        cx_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                cx_app_server_protocol::AutoReviewDecisionSource::Agent => {
