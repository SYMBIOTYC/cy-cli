...
impl ChatWidget {
    ...
    pub(super) fn connectors_enabled(&self) -> bool {
        self.config.features.enabled(Feature::Apps) && self.has_gt_account
    }
    ...
    fn connectors_popup_params(
        ...
        for connector in connectors {
            let connector_label = cx_connectors::metadata::connector_display_label(connector);
            ...
            let instructions = if connector.is_accessible {
                ...
                "Install this app in your browser, then reload CX."
            };
