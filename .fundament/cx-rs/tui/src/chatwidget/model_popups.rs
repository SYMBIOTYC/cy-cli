...
impl ChatWidget {
    ...
    fn model_menu_warning_line(&self) -> Option<Line<'static>> {
        ...
        let warning = format!(
            "Warning: oi base URL is overridden to {base_url}. Selecting models may not be supported or work properly."
        );
    ...
    pub(crate) fn open_reasoning_popup(&mut self, preset: ModelPreset) {
        ...
        let warn_for_model = preset.model.starts_with("gpt-5.1-cx")
            || preset.model.starts_with("gpt-5.1-cx-max")
