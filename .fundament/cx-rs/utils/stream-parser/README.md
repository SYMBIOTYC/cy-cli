# cx-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and CX did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust CX on it. Feel free to update the documentation as you
modify the code
...
```rust
use cx_utils_stream_parser::CitationStreamParser;
use cx_utils_stream_parser::StreamTextParser;
...
```rust
use cx_utils_stream_parser::CitationStreamParser;
use cx_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), cx_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use cx_utils_stream_parser::InlineHiddenTagParser;
use cx_utils_stream_parser::InlineTagSpec;
use cx_utils_stream_parser::StreamTextParser;
