...
pub fn builtin_approval_presets() -> Vec<ApprovalPreset> {
    vec![
        ApprovalPreset {
            id: "read-only",
            label: "Read Only",
            description: "Read workspace files. Edits and network require approval.",
        ...
        ApprovalPreset {
            id: "auto",
            label: "Default",
            description: "Read, edit, and run commands in this workspace. Network and other files need approval.",
            approval: AskForApproval::OnRequest,
            active_permission_profile: ActivePermissionProfile::new(
        ...
        ApprovalPreset {
            id: "full-access",
            label: "Full Access",
            description: "Edit any file and use the network with no prompts. Use with care.",
