//! Helpers for truncating tool and exec output using [`TruncationPolicy`](cx_protocol::protocol::TruncationPolicy).

use cx_protocol::models::FunctionCallOutputContentItem;
pub use cx_utils_string::approx_bytes_for_tokens;
pub use cx_utils_string::approx_token_count;
pub use cx_utils_string::approx_tokens_from_byte_count;
use cx_utils_string::truncate_middle_chars;
use cx_utils_string::truncate_middle_with_token_budget;

pub use cx_protocol::protocol::TruncationPolicy;
