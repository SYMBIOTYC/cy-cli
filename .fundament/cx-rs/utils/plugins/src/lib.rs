//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across CX
//! crates.
...
pub use cx_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
...
const PLUGIN_METADATA_DIR: &str = ".cx-plugin";
