...
use cx_rollout::ModelContextScan;
use cx_rollout::ModelContextScanProgress;
use cx_rollout::ReverseJsonlScanner;
use cx_rollout::RolloutItem;
use cx_rollout::RolloutLine;
use cx_rollout::ScanOutcome;
...
pub(super) async fn load_for_fork(
    ...
    let session_meta = cx_rollout::read_session_meta_line(source_path)
        .await
        .map_err(|err| ThreadStoreError::Internal {
            message: format!(
