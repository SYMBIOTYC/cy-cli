...
use cx_rollout::first_rollout_content_match_snippet;
use cx_rollout::parse_cursor;
use cx_rollout::search_rollout_matches;
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = cx_rollout::plain_rollout_path(item.path.as_path());
