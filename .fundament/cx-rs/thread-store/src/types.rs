...
use cx_protocol::protocol::ThreadMemoryMode as MemoryMode;
...
pub struct CreateThreadParams {
    ...
    /// Thread id generated by CX before opening persistence.
...
pub struct StoredTurnError {
    ...
    pub message: String,
    /// Structured CX error classification, when available.
...
mod tests {
    ...
    fn session_meta(history_mode: ThreadHistoryMode) -> RolloutItem {
        RolloutItem::SessionMeta(cx_protocol::protocol::SessionMetaLine {
