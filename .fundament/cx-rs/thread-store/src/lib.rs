...
//!
//! Application code should treat [`cx_protocol::ThreadId`] as the only durable thread handle.
...
pub use cx_state::MAX_QUEUE_ITEMS;
pub use cx_state::QueuedUserSubmissionRecord;
