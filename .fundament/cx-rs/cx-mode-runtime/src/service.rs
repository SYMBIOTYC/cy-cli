...
use cx_code_mode_protocol::CodeModeSession;
use cx_code_mode_protocol::CodeModeSessionCellExecutionLimits;
use cx_code_mode_protocol::CodeModeSessionDelegate;
use cx_code_mode_protocol::CodeModeSessionResultFuture;
use cx_code_mode_protocol::CodeModeToolKind;
use cx_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use cx_code_mode_protocol::ExecuteRequest;
use cx_code_mode_protocol::ExecuteToPendingOutcome;
use cx_code_mode_protocol::FunctionCallOutputContentItem;
use cx_code_mode_protocol::ImageDetail;
use cx_code_mode_protocol::NoopCodeModeSessionDelegate;
...
use cx_code_mode_protocol::WaitToPendingOutcome;
use cx_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: cx_protocol::ToolName {
