...
///
/// This prevents accidental propagation of CX launch context; it is not a
...
mod windows_tests {
    ...
    fn core_inherit_preserves_windows_startup_vars_case_insensitively() {
        let vars = make_vars(&[
            ...
            ("AppData", "C:\\Users\\cx\\AppData\\Roaming"),
        ...
        let expected = HashMap::from([
            ...
            (
                "AppData".to_string(),
                "C:\\Users\\cx\\AppData\\Roaming".to_string(),
            ),
...
mod non_windows_tests {
    ...
    fn core_inherit_preserves_non_windows_core_vars_case_insensitively() {
        ...
        let expected = HashMap::from([
            ...
            ("home".to_string(), "/home/cx".to_string()),
