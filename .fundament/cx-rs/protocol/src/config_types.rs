...
/// Serialized with lowercase values to match the oi API.
#[derive(
    Hash,
    Debug,
    Serialize,
...
/// Validated plain profile-v2 name used to select `$CX_HOME/<name>.config.toml`.
...
/// Collaboration mode for a CX session.
