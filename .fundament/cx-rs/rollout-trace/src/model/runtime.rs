...
/// Runtime operation requested by the model, a JS code cell, or CX itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_cx_turn_id: Option<CodexTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the CX tool boundary.
    ///
    ...
    /// they describe how CX executed the request, not what the caller sent.
