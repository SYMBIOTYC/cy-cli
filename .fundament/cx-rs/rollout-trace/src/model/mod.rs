...
/// Process/session ID returned by CX's terminal runtime.
...
/// Canonical reduced graph for one CX rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the CX rollout/session being observed. `trace_id`
    ...
    pub cx_turns: BTreeMap<CodexTurnId, CodexTurn>,
