...
/// One CX thread/session participating in the rollout.
///
...
/// Provenance for a traced CX thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the CX runtime for one thread.
///
/// A CX turn groups protocol/runtime work for one thread activation.
