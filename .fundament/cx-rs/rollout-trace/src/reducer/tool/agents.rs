...
use anyhow::Result;
use anyhow::bail;
use cx_protocol::protocol::CollabAgentInteractionBeginEvent;
use cx_protocol::protocol::CollabAgentInteractionEndEvent;
use cx_protocol::protocol::CollabAgentSpawnEndEvent;
use cx_protocol::protocol::CollabCloseBeginEvent;
use cx_protocol::protocol::CollabCloseEndEvent;
...
pub(in crate::reducer) struct ObservedAgentResultEdge {
    ...
    pub(in crate::reducer) child_cx_turn_id: String,
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.cx_turn_id.as_deref() == Some(cx_turn_id)
