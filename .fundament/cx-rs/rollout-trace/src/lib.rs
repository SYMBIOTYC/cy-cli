//! Trace bundle format, writer, and reducer for CX rollouts.
//!
//! This crate owns the trace schema. Hot-path CX code should depend on the
...
/// Shared recorder context for inference attempts within one CX turn.
...
pub use thread::CX_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical CX tool boundary.
...
/// Append-only writer used by hot-path CX instrumentation.
