...
//! `EscalateRequest` over the inherited `CX_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `CX_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use cx_protocol::approvals::EscalationPermissions;
pub use cx_protocol::approvals::ResolvedPermissionProfile;
