...
Set a stable path to the skill CLI (default `CODEX_HOME` is `~/.cx`):

```
export CODEX_HOME="${CODEX_HOME:-$HOME/.cx}"
...
- Network/sandbox notes for fallback CLI mode: `references/cx-network.md`
