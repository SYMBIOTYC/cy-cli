---
name: "imagegen"
description: "Generate or edit raster images when the task benefits from AI-created bitmap visuals such as photos, illustrations, textures, sprites, mockups, or transparent-background cutouts. Use when CX should create a brand-new image, transform an existing image, or derive visual variants from references, and the output should be a bitmap asset rather than repo-native code or vector. Do not use when the task is better handled by editing existing SVG/vector/code-native assets, extending an established icon or logo system, or building the visual directly in HTML/CSS/canvas."
---
...
- In built-in tool mode, CX saves generated images under `$CODEX_HOME/*` by default.
...
1. Create an API key in the oi platform UI: https://platform.openai.com/api-keys
...
- Network approvals / sandbox settings for CLI mode: `references/cx-network.md`
...
- `references/cx-network.md`: fallback-only network/sandbox troubleshooting for CLI mode.
