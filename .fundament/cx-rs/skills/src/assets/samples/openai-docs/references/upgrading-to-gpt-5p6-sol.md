...
Use this guide when the user asks to migrate an existing oi API integration, repository, prompt stack, agent, model router, or model picker to GPT-5.6 Sol or the GPT-5.6 family.
...
- the `oi-Beta: responses_multi_agent=v1` header;
