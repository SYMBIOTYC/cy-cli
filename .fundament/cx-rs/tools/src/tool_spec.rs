...
use cx_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
use cx_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
use cx_protocol::config_types::WebSearchUserLocationType;
use serde::Serialize;
use serde_json::Value;
use serde_json::value::RawValue;
use std::sync::Arc;

/// When serialized as JSON, this produces a valid "Tool" in the oi
/// Responses API.
