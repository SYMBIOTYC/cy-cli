...
fn disk_capacity_is_reported_without_loaded_configuration() {
    ...
    for label in ["CX_HOME available: ", "worktree available: "] {
        assert!(
            check
                .details
                .iter()
        ...
        assert_eq!(
            ...
            json!({
                ...
                "details": [
                    ...
                    format!("CX_HOME available: {measured}"),
    ...
    assert_eq!(
        ...
        json!({
            ...
            "details": [
                "warning threshold: 5.0 GiB",
                "failure threshold: 1.0 GiB",
                "CX_HOME available: unavailable (PermissionDenied)",
...
#[test]
fn nonexistent_relative_cx_home_uses_current_directory_capacity() {
