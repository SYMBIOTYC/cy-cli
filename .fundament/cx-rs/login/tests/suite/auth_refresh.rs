...
const SYSTEM_PROXY_TEST_SUBPROCESS_ENV_VAR: &str = "CX_AUTH_SYSTEM_PROXY_TEST_SUBPROCESS";
const SYSTEM_PROXY_TEST_PROXY_URL_ENV_VAR: &str = "CX_AUTH_SYSTEM_PROXY_TEST_PROXY_URL";
...
async fn refresh_token_honors_respect_system_proxy() -> Result<()> {
    ...
    let auth_manager = AuthManager::shared(
        ...
        /*auth_route_config*/
        cx_login::AuthRouteConfig::from_http_client_factory(HttpClientFactory::new(
...
#[serial_test::serial(auth_env)]
#[tokio::test]
async fn unauthorized_recovery_requires_gt_auth() -> Result<()> {
    skip_if_no_network!(Ok(()));
