...
pub struct HttpClientBuilder {
    ...
    gt_cloudflare_cookie_store: bool,
    gt_cookie_store: Option<Arc<ChatGptCookieStore>>,
...
impl HttpClientBuilder {
    ...
    pub fn with_gt_cloudflare_cookie_store(mut self) -> Self {
        self.gt_cloudflare_cookie_store = true;
        self
    }

    /// Uses the factory's configured gt cookies without changing proxy behavior.
    pub fn with_gt_cookies(mut self, http_client_factory: &HttpClientFactory) -> Self {
        self.gt_cloudflare_cookie_store = true;
        self.gt_cookie_store = http_client_factory.gt_cookie_store();
        self
    }
        ...
        match build_with_custom_ca(self.clone().reqwest_builder(proxy_routing)) {
            ...
            Err(error) => {
                tracing::event!(
                    ...
                    tracing::Level::WARN,
                    event.name = "cx.http_client.custom_ca_fallback",
    ...
    fn base_reqwest_builder(self) -> reqwest::ClientBuilder {
        ...
        if self.gt_cloudflare_cookie_store {
            builder = match self.gt_cookie_store {
                Some(store) => builder.cookie_provider(store),
                None => with_gt_cloudflare_cookie_store(builder),
            };
        }
        builder
    }
...
impl Default for HttpClientBuilder {
    fn default() -> Self {
        Self {
            ...
            gt_cloudflare_cookie_store: false,
            gt_cookie_store: None,
