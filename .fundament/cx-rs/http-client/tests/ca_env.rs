...
//! detailed explanation of what "hermetic" means here lives in `cx_http_client::custom_ca`; these
...
fn generate_tls13_material() -> Tls13Material {
    ...
    ca_distinguished_name.push(DnType::CommonName, "cx test CA");
...
#[test]
fn prefers_cx_ca_cert_over_ssl_cert_file() {
    let temp_dir = TempDir::new().expect("tempdir");
    let cert_path = write_cert_file(&temp_dir, "ca.pem", TEST_CERT_1);
