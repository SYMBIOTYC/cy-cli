...
impl Hooks {
    ...
    ) -> anyhow::Result<(Self, Receiver<cx_protocol::protocol::HookCompletedEvent>)> {
    ...
    ) -> Vec<cx_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_session_end(&self) -> Vec<cx_protocol::protocol::HookRunSummary> {
