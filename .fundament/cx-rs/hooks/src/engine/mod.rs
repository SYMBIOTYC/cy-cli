...
use cx_protocol::protocol::HookTrustStatus;
...
pub(crate) struct ConfiguredHandler {
    pub event_name: cx_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            cx_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            cx_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            cx_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            cx_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            cx_protocol::protocol::HookEventName::PostCompact => "post-compact",
            cx_protocol::protocol::HookEventName::SessionStart => "session-start",
            cx_protocol::protocol::HookEventName::SessionEnd => "session-end",
            cx_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            cx_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            cx_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            cx_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
