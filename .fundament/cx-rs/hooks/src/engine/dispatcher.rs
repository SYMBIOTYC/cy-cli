...
pub(crate) fn completed_summary(
    ...
    entries: Vec<cx_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
...
pub(crate) fn hook_source_label(source: cx_protocol::protocol::HookSource) -> &'static str {
    match source {
        cx_protocol::protocol::HookSource::System => "system",
        cx_protocol::protocol::HookSource::User => "user",
        cx_protocol::protocol::HookSource::Project => "project",
        cx_protocol::protocol::HookSource::Mdm => "mdm",
        cx_protocol::protocol::HookSource::SessionFlags => "session_flags",
