...
const SETUP_BIN: &str = "cx-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "cx-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so CX binaries that link the
