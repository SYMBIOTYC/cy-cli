...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        cx_home: PathBuf::from(r"C:\Users\cx"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\cx\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            cx_home: PathBuf::from(r"C:\Users\cx\.sandbox"),
            real_cx_home: PathBuf::from(r"C:\Users\cx"),
        ...
        deny_write_paths_override: vec![PathBuf::from(r"C:\workspace\.cx")],
        proxy_enforced: true,
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |cx_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
