...
//! cx home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox cx home directory exists.
pub fn ensure_cx_home_exists(p: &Path) -> Result<()> {
