...
const SESSION_NAME: &str = "CX Windows Sandbox WFP";
const PROVIDER_NAME: &str = "CX Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for CX Windows sandbox filters";
const SUBLAYER_NAME: &str = "CX Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for CX Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are CX-owned identities; do not regenerate them unless we
...
/// Installs the persistent CX WFP filters for `account`.
///
...
/// Ensures the persistent CX WFP provider exists.
...
/// Ensures the persistent CX sublayer exists under the CX provider.
