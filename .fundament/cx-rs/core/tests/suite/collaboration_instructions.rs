...
use cx_protocol::openai_models::CollaborationModeMessages;
use cx_protocol::openai_models::ModelMessages;
use cx_protocol::openai_models::ModelsResponse;
use cx_protocol::protocol::COLLABORATION_MODE_CLOSE_TAG;
...
fn model_with_collaboration_messages(
    ...
    default: Option<&str>,
    plan: Option<&str>,
) -> cx_protocol::openai_models::ModelInfo {
            ...
            .with_thread_settings(ThreadSettingsOverrides {
                ...
                summary: Some(
                    test.config
                        ...
                        .unwrap_or(cx_protocol::config_types::ReasoningSummary::Auto),
                ),
                collaboration_mode: Some(collaboration_mode),
                ..Default::default()
            }),
