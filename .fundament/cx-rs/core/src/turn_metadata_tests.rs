...
fn turn_metadata_state_merges_client_metadata_without_replacing_reserved_fields() {
    ...
    state.set_responsesapi_client_metadata(HashMap::from([
        ...
        (
            "x-cx-installation-id".to_string(),
            "client-supplied".to_string(),
        ),
        (
            "x-cx-parent-thread-id".to_string(),
            "client-supplied".to_string(),
        ),
        (
    ...
    assert_eq!(json["cx_security_surface"].as_str(), Some("sdk"));
    ...
    assert!(json.get("x-cx-installation-id").is_none());
    assert!(json.get("x-cx-parent-thread-id").is_none());
    ...
    assert_eq!(
        model_request_json["cx_security_surface"].as_str(),
        Some("sdk")
    );
    assert_eq!(
    ...
    assert!(meta.get("cx_security_surface").is_none());
...
fn turn_metadata_state_overlays_compaction_only_on_compaction_requests() {
    ...
    assert_eq!(compact_json["cx_security_surface"].as_str(), Some("sdk"));
    assert_eq!(
    ...
    assert_eq!(regular_json["cx_security_surface"].as_str(), Some("sdk"));
