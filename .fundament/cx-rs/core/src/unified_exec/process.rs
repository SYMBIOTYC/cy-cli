...
use cx_exec_server::ExecProcessEvent;
use cx_exec_server::ProcessSignal as ExecServerProcessSignal;
use cx_exec_server::ReadResponse as ExecReadResponse;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = cx_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
