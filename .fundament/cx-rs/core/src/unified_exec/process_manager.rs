...
use cx_core_plugins::strip_output_env;
...
use cx_protocol::protocol::TerminalInteractionEvent;
...
fn exec_server_env_for_request(
    ...
    Option<cx_exec_server::ExecEnvPolicy>,
    HashMap<String, String>,
) {
...
fn network_approval_error_message(err: ToolError) -> String {
    match err {
        ...
        ToolError::CX(err) => err.to_string(),
    }
}
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        network_proxy_launch: Option<cx_network_proxy::RemoteNetworkProxyLaunchConfig>,
    ...
    pub(crate) async fn open_session_with_prepared_exec_env(
        ...
        let network_proxy_restricting_sid = {
            ...
            {
                if request.sandbox == cx_sandboxing::SandboxType::WindowsRestrictedToken {
                    request
                        .network
                        .as_ref()
                        .map(|network| {
        ...
        let windows_sandbox =
            if request.sandbox == cx_sandboxing::SandboxType::WindowsRestrictedToken {
                Some(cx_sandboxing::WindowsSandboxSpawnRequest {
        ...
        let spawn_result = cx_sandboxing::spawn_process(cx_sandboxing::SpawnRequest {
    ...
    pub(super) async fn open_session_with_sandbox(
        ...
        orchestrator
            ...
            .map_err(|err| match err {
                ToolError::CX(err) => match err.details() {
