...
command transformation live in the cx-sandboxing crate; this module keeps
...
pub(crate) struct ExecServerEnvConfig {
    pub(crate) policy: cx_exec_server::ExecEnvPolicy,
...
) -> cx_protocol::error::Result<ExecToolCallOutput> {
