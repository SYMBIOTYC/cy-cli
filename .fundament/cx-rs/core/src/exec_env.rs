pub use cx_apply_patch::CODEX_APPLY_PATCH_PRESERVE_LINE_ENDINGS_ENV_VAR;
...
pub use cx_protocol::shell_environment::CODEX_SESSION_ID_ENV_VAR;
pub use cx_protocol::shell_environment::CODEX_THREAD_ID_ENV_VAR;
