...
pub(crate) struct Session {
    ...
    pub(super) mcp_elicitation_reviewer_handle: OnceLock<cx_mcp::ElicitationReviewerHandle>,
    pub(super) mcp_elicitation_lifecycle_handle: OnceLock<cx_mcp::ElicitationLifecycle>,
...
pub(crate) struct SessionConfiguration {
    ...
    /// Directory containing all CX state for this session.
    pub(super) cx_home: AbsolutePathBuf,
...
impl SessionConfiguration {
    ...
    pub(crate) fn cx_home(&self) -> &AbsolutePathBuf {
        &self.cx_home
    }
    ...
    pub(super) fn sandbox_policy(
        ...
        cx_sandboxing::compatibility_sandbox_policy_for_permission_profile(
            &permission_profile,
            self.cwd(),
        )
    }
    ...
    pub(super) fn validate(
        ...
        super::environment::validate_environment_selections(environments).map_err(|error| {
            ConstraintError::InvalidValue {
                ...
                requirement_source: cx_config::RequirementSource::Unknown,
            }
        })
    }
...
impl Session {
    ...
    pub(crate) async fn new(
        ...
        environment_selections: &[TurnEnvironmentSelection],
        config: Arc<Config>,
        user_instructions: Option<cx_extension_api::UserInstructions>,
        ...
        code_mode_session_provider: Arc<dyn cx_code_mode::CodeModeSessionProvider>,
        extensions: Arc<cx_extension_api::ExtensionRegistry<crate::config::Config>>,
        ...
        thread_extension_init.insert(cx_extension_api::ThreadOriginator(
            session_configuration.originator.clone(),
        ));
        let mcp_thread_init = thread_extension_init.clone();
        let thread_extension_data = cx_extension_api::ExtensionData::new_with_init(
            thread_id.to_string(),
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let config_path = config.cx_home.join(CONFIG_TOML_FILE);
            ...
            let auth_env_telemetry = collect_auth_env_telemetry(
                ...
                auth_manager.cx_api_key_env_enabled(),
            );
            ...
            let session_extension_data =
                cx_extension_api::ExtensionData::new(session_id.to_string());
            ...
            for contributor in extensions.thread_lifecycle_contributors() {
                contributor.on_thread_start(cx_extension_api::ThreadStartInput {
            ...
            let session_start_source = match &initial_history {
                InitialHistory::Resumed(_) => cx_hooks::SessionStartSource::Resume,
                InitialHistory::New | InitialHistory::Forked(_) => {
                    cx_hooks::SessionStartSource::Startup
                }
                InitialHistory::Cleared => cx_hooks::SessionStartSource::Clear,
            };
