...
//! inputs and the mutable [`cx_mcp::McpRuntime`]. Background scheduling
//! belongs elsewhere.
...
impl Session {
    ...
    pub(super) fn build_mcp_runtime_input(
        ...
        config
            .environment_cwds
            .entry(cx_config::DEFAULT_MCP_SERVER_ENVIRONMENT_ID.to_string())
        ...
        McpRuntimeInput {
            ...
            runtime_context,
            cx_apps_tools_cache: self.services.mcp_manager.cx_apps_tools_cache(),
