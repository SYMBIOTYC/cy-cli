...
use cx_core_plugins::ResolvedPluginMetricsOperation;
use cx_core_plugins::TrustedPluginRoots;
...
use cx_protocol::permissions::RawFileSystemSandboxPolicy;
...
pub struct TurnContext {
    ...
    pub(crate) extension_data: Arc<cx_extension_api::ExtensionData>,
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
            cx_tools::unified_exec_feature_mode_for_features(per_turn_config.features.get()),
        ...
        let extension_data = Arc::new(cx_extension_api::ExtensionData::new(sub_id.clone()));
    ...
    async fn new_turn_context_from_configuration(
        ...
        let trusted_plugin_roots = TrustedPluginRoots::from_plugin_load_outcome(
            &plugin_outcome,
            per_turn_config.cx_home.as_path(),
        );
    ...
    pub(crate) async fn maybe_emit_model_warnings_for_turn(&self, tc: &TurnContext) {
        ...
        if !tc.code_mode_available
            && matches!(
                ...
                cx_protocol::openai_models::ToolMode::CodeMode
                    | cx_protocol::openai_models::ToolMode::CodeModeOnly
            )
