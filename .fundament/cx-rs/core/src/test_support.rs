...
use cx_models_manager::collaboration_mode_presets;
...
pub fn auth_manager_from_auth_with_home(auth: CodexAuth, cx_home: PathBuf) -> Arc<AuthManager> {
    AuthManager::from_auth_for_testing_with_home(auth, cx_home)
}
...
) -> cx_protocol::error::Result<crate::NewThread> {
    thread_manager
...
pub fn models_manager_with_provider(
    ...
    provider.models_manager(cx_home, /*config_model_catalog*/ None)
}
