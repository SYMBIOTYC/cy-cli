...
use cx_prompts::render_review_exit_interrupted;
use cx_prompts::render_review_exit_success;
...
use cx_protocol::review_format::format_review_findings_block;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        // Start sub-cx conversation and get the receiver for events.
