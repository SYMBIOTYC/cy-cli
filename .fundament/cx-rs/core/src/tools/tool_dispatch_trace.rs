...
//!
//! `cx-rollout-trace` owns the event schema and writer behavior. This module
...
use cx_rollout_trace::ToolDispatchInvocation;
use cx_rollout_trace::ToolDispatchPayload;
use cx_rollout_trace::ToolDispatchRequester;
use cx_rollout_trace::ToolDispatchResult;
use cx_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        cx_turn_id: invocation.turn.sub_id.clone(),
