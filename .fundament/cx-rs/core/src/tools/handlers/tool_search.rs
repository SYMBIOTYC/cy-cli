...
use cx_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use cx_tools::TOOL_SEARCH_TOOL_NAME;
use cx_tools::ToolName;
use cx_tools::ToolSearchEntry;
use cx_tools::ToolSearchInfo;
use cx_tools::ToolSpec;
use cx_tools::coalesce_loadable_tool_specs;
use std::sync::Arc;
use std::sync::Mutex;
use std::sync::Weak;
...
mod tests {
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        let dynamic_namespace = DynamicToolNamespaceSpec {
            ...
            description: "Tools in the cx_app namespace.".to_string(),
            tools: Vec::new(),
        };
