...
) -> cx_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => cx_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => cx_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => cx_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => cx_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => cx_tools::ToolUserShellType::Cmd,
    }
}
