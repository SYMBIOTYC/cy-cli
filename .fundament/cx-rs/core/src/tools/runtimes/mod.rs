...
pub(crate) use cx_network_proxy::is_managed_proxy_env_var;
pub(crate) use cx_network_proxy::strip_managed_proxy_env;
...
/// PATH entries owned by CX runtime setup.
///
...
fn build_proxy_env_exports() -> (String, String) {
    ...
    let git_blocks = build_cx_proxy_git_ssh_command_exports();
    (
