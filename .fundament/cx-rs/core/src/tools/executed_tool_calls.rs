...
use cx_protocol::models::ExecutedToolCall;
use cx_protocol::models::ResponseItem;
use cx_protocol::models::bound_executed_tool_calls_for_prompt_prioritizing_recent;
use cx_protocol::models::executed_tool_call_metadata_bytes;
...
impl ExecutedToolCallRecorder {
    pub(crate) fn record_tool_call(
        ...
        let name = cx_tools::code_mode_name_for_tool_name(&call.tool_name);
