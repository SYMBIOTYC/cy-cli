...
use cx_connectors::PluginConnectorSource;
...
use cx_mcp::ToolInfo;
use cx_mcp::cx_apps_mcp_server_config;
use cx_mcp::configured_mcp_servers;
...
const LEGACY_CODEX_APPS_REGISTRATION_ID: &str = "legacy_cx_apps";
...
impl McpManager {
    ...
    pub fn cx_apps_tools_cache(&self) -> ConnectorRuntimeManager<ToolInfo> {
        self.cx_apps_tools_cache.clone()
    }
