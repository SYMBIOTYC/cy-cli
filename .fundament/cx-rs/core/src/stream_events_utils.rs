...
use cx_utils_stream_parser::strip_proposed_plan_blocks;
use futures::Future;
use tracing::debug;
        ...
        && role == "assistant"
    {
        let combined = content
            ...
            .filter_map(|ci| match ci {
                cx_protocol::models::ContentItem::OutputText { text } => Some(text.as_str()),
                _ => None,
            })
            .collect::<String>();
...
pub(crate) async fn finalize_turn_item(
    ...
    if let TurnItem::AgentMessage(agent_message) = &mut *turn_item {
        ...
        agent_message.content =
            vec![cx_protocol::items::AgentMessageContent::Text { text: stripped }];
