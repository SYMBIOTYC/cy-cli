...
//!
//! # async fn example(state_db: std::sync::Arc<cx_state::StateRuntime>) {
...
pub fn default_filter() -> Targets {
    Targets::new()
        ...
        .with_target("cx_rmcp_client", LevelFilter::INFO)
        .with_target("cx_otel.log_only", LevelFilter::OFF)
        .with_target("cx_otel.trace_safe", LevelFilter::OFF)
        ...
        .with_target("cx_tui::streaming::controller", LevelFilter::DEBUG)
        .with_target("cx_tui::streaming::table_holdback", LevelFilter::DEBUG)
}
    ...
    S: tracing::Subscriber + for<'a> LookupSpan<'a>,
{
    ...
    fn on_event(&self, event: &Event<'_>, ctx: tracing_subscriber::layer::Context<'_, S>) {
        ...
        // were over 30% of retained logs in measured high-fanout CX environments.
...
mod tests {
    ...
    fn temp_cx_home() -> std::path::PathBuf {
        std::env::temp_dir().join(format!("cx-state-log-db-{}", Uuid::new_v4()))
    }
