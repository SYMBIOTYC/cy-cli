...
pub type LoadedPlugin = cx_plugin::LoadedPlugin<cx_config::McpServerConfig>;
pub type PluginLoadOutcome = cx_plugin::PluginLoadOutcome<cx_config::McpServerConfig>;
