...
use cx_model_provider_info::AMAZON_BEDROCK_GPT_5_6_TERRA_MODEL_ID;
use cx_model_provider_info::AMAZON_BEDROCK_RUNTIME_GLOBAL_GPT_5_6_LUNA_MODEL_ID;
use cx_model_provider_info::AMAZON_BEDROCK_RUNTIME_GLOBAL_GPT_5_6_TERRA_MODEL_ID;
...
/// Runtime provider for Amazon Bedrock's oi-compatible endpoints.
#[derive(Clone, Debug)]
    ...
    fn account_state(&self) -> ProviderAccountResult {
        Ok(ProviderAccountState {
            account: Some(ProviderAccount::AmazonBedrock {
                uses_cx_managed_credentials: self.managed_auth().is_some(),
            }),
