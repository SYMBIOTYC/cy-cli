use cx_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use cx_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use cx_app_server_protocol::CollabAgentTool;
use cx_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use cx_app_server_protocol::CommandAction;
use cx_app_server_protocol::CommandExecutionSource;
use cx_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use cx_app_server_protocol::ErrorNotification;
use cx_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
use cx_app_server_protocol::ItemCompletedNotification;
use cx_app_server_protocol::ItemStartedNotification;
use cx_app_server_protocol::McpToolCallError;
use cx_app_server_protocol::McpToolCallResult;
use cx_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use cx_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use cx_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use cx_app_server_protocol::WebSearchAction as ApiWebSearchAction;
use cx_app_server_protocol::WebSearchItem as ApiWebSearchItem;
...
use cx_exec::AgentMessageItem;
use cx_exec::CodexStatus;
use cx_exec::CollabAgentState;
use cx_exec::CollabAgentStatus;
use cx_exec::CollabTool;
use cx_exec::CollabToolCallItem;
use cx_exec::CollabToolCallStatus;
use cx_exec::CollectedThreadEvents;
use cx_exec::CommandExecutionItem;
use cx_exec::CommandExecutionStatus;
use cx_exec::ErrorItem;
use cx_exec::EventProcessorWithJsonOutput;
use cx_exec::ExecThreadItem;
use cx_exec::FileChangeItem;
use cx_exec::FileUpdateChange as ExecFileUpdateChange;
use cx_exec::ItemCompletedEvent;
use cx_exec::ItemStartedEvent;
use cx_exec::ItemUpdatedEvent;
use cx_exec::McpToolCallItem;
use cx_exec::McpToolCallItemError;
use cx_exec::McpToolCallItemResult;
use cx_exec::McpToolCallStatus;
use cx_exec::PatchApplyStatus;
use cx_exec::PatchChangeKind;
use cx_exec::ReasoningItem;
use cx_exec::ThreadErrorEvent;
use cx_exec::ThreadEvent;
use cx_exec::ThreadItemDetails;
use cx_exec::ThreadStartedEvent;
use cx_exec::TodoItem;
use cx_exec::TodoListItem;
use cx_exec::TurnCompletedEvent;
use cx_exec::TurnFailedEvent;
use cx_exec::TurnStartedEvent;
use cx_exec::Usage;
use cx_exec::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_configured = SessionConfiguredEvent {
        ...
        thread_source: None,
        thread_name: None,
        model: "cx-mini-latest".to_string(),
        model_provider_id: "test-provider".to_string(),
        service_tier: None,
        approval_policy: AskForApproval::Never,
        approvals_reviewer: cx_protocol::config_types::ApprovalsReviewer::User,
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        cx_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: cx_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
