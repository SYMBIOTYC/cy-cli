...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        ...
        Self {
            shell: cx_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `cx-linux-sandbox` are command
...
mod tests {
    ...
    use cx_network_proxy::RemoteNetworkProxyLaunchConfig;
    use cx_protocol::config_types::WindowsSandboxProxySettingsMode;
