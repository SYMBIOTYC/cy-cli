...
struct ResponseCompletedUsage {
    ...
    total_tokens: i64,
    #[serde(default)]
    cx_rollout_budget_units: Option<serde_json::Number>,
}
...
impl From<ResponseCompletedUsage> for TokenUsage {
    fn from(val: ResponseCompletedUsage) -> Self {
        ...
        TokenUsage {
            ...
            cx_rollout_budget_units: val.cx_rollout_budget_units,
        }
    }
}
...
impl ResponsesStreamEvent {
    ...
    pub(crate) fn turn_moderation_metadata(&self) -> Option<TurnModerationMetadataEvent> {
        ...
        self.metadata
            .as_ref()
            .and_then(|metadata| metadata.get("openai_gt_moderation_metadata"))
            .cloned()
...
mod tests {
    ...
    fn parses_cache_write_token_usage() {
        ...
        assert_eq!(
            ...
            TokenUsage {
                ...
                total_tokens: 110,
                cx_rollout_budget_units: serde_json::Number::from_f64(2.5),
            }
        );
    }
        ...
        let events = run_sse(vec![
            json!({
                ...
                "response": {
                    "id": "resp-1",
                    "headers": {
                        "oi-Model": CYBER_RESTRICTED_MODEL_FOR_TESTS
                    }
                }
            }),
            json!({
    ...
    const CYBER_RESTRICTED_MODEL_FOR_TESTS: &str = "gpt-5.3-cx";
}
