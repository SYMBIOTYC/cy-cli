...
impl<T: HttpTransport> ModelsClient<T> {
    ...
    fn append_client_version_query(req: &mut cx_client::Request, client_version: &str) {
...
mod tests {
    ...
    async fn appends_client_version_query() {
        ...
        let provider = provider("https://example.com/api/cx");
        ...
        assert_eq!(
            url,
            "https://example.com/api/cx/models?client_version=0.99.0"
        );
    }
