...
use cx_protocol::openai_models::ModelInstructionsVariables;
use cx_protocol::openai_models::ModelMessages;
use cx_protocol::openai_models::ModelVisibility;
use cx_protocol::openai_models::TruncationMode;
...
const DEFAULT_PERSONALITY_HEADER: &str = "You are CX, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.";
...
fn local_model_messages_for_slug(slug: &str) -> ModelMessages {
    match slug {
        "gpt-5.2-cx" | "exp-cx-personality" => ModelMessages {
