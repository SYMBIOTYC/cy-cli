//! Resolve the release identity of the current CX runtime.
...
impl BuildInfo {
    /// Return build information for the current CX runtime.
    pub fn get() -> Self {
        BUILD_INFO
    ...
    /// Format the version for a user-facing CX header.
